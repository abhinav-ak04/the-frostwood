    ...
    <div className="grid grid-cols-5 items-center gap-x-24 gap-y-32 text-lg">
      ...
      <div className="relative col-span-2 aspect-square">
        <Image
          ...
          alt="Family that manages The Frostwood"
        />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Frostwood has been a cherished family-run retreat.
            Started by our grandparents, this haven has been nurtured with love
            and care, passing down through our family as a testament to our
            dedication to creating a warm, welcoming environment.
          </p>
          <p>
            Over the years, we&apos;ve maintained the essence of The Frostwood,
            blending the timeless beauty of the mountains with the personal
            touch only a family business can offer. Here, you&apos;re not just a
            guest; you&apos;re part of our extended family. So join us at The
            Frostwood soon, where tradition meets tranquility, and every visit
            is like coming home.
          </p>
